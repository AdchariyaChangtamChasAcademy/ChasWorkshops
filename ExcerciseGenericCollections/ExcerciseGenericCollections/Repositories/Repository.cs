using ExcerciseGenericCollections.Models;
using System;
...
namespace ExcerciseGenericCollections.Repositories
{
    public class Repository
    {
        public List<Models.Product> Products { get; } = new()
        {
        ...
        public List<Models.Customer> Customers { get; } = new()
        {
